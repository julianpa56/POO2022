...
class ManejadorViajerosFrecuentes:
    ...
    def opcionesViajero(self,listaViajeros:list[ViajeroFrecuente]):
        ...
        if(respuesta==-1):
            ...
            opciones= {'1': listaViajeros[respuesta].cantidadTotalMillas , '2': listaViajeros[respuesta].acumularMillas , '3' : listaViajeros[respuesta].canjearMillas }
            ...
            while (op != 4):
                if op==1:
                    ...
                    res=opciones.get(op,error)(millas)
    ...
    def buscarViajero(self,listaViajeros:list[ViajeroFrecuente],auxId:int):
        i=0
        b= True
